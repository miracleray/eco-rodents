...
text(-0.02, 0.08, expression(paste("(Marcy et al. ", italic("in review"), ")")), cex = 0.8)  # first submission
...
plot(x = res.PCA$pc.scores[, 1],  # no flip for consistency
                 ...
                 cex.axis = 1.1, 
                 cex.lab = 1.3)
legend("bottomleft", legend = genera.phylo.full, col = col.phylo, pch = 16, pt.bg = col.unique.spp, cex = 0.8, pt.cex = 0.85, bty = "n", text.font = 3)
