...
Creates supplementary Figure TK, a screeplot of the the PCs for each dataset.
...
pdf("../Data/Results/Figure1_PCAs_2020.pdf")
...
mtext("A) full shape dataset", 3, line = 1, cex = 0.8, adj = 0, col = "black")

# 2)
barplot(res.PC.impt[, 2], ylab = "% of variance", ylim = c(0, 0.5))
abline(h = 0.1, col = 'deeppink4')
mtext("B) shape residual dataset", 3, line = 1, cex = 0.8, adj = 0, col = "black")

# 3)
barplot(rnot.PC.impt[, 2], xlab = "Principal component" , ylab = "% of variance", ylim = c(0, 0.5))
abline(h = 0.1, col = 'deeppink4')
mtext(expression(paste("C) shape residual dataset without ", italic(Notomys))), 3, line = 1, cex = 0.8, adj = 0, col = "black")
