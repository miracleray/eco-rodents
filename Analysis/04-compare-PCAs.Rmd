...
text(-0.025, 0.08, expression(paste("(Marcy et al. ", italic("in review"), ")")), cex = 0.8)  # first submission
...
plot(x = res.PCA$pc.scores[, 1],  # no flip for consistency
                 ...
                 cex.axis = 1.1, 
                 cex.lab = 1.3)
legend("bottomleft", legend = c("Aquatic", "Arboreal", "Terrestrial", "Hopping", "", "Carnivore", "Frugivore", "Granivore", "Folivore", "Omnivore"), col = c(rep("black", 4), "white", col.diet.5), border = NULL, pch = c(21, 24, 22, 23, rep(16, 6)), cex = 0.85, bty = "n")
...
### Correlation of residual PC1 and full shape PC2
```{r}
