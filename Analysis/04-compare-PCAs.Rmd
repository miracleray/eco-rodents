...
plot(x = res.PCA$pc.scores[, 1],  # no flip for consistency
                 ...
                 cex.axis = 1.1, 
                 cex.lab = 1.3)
legend("bottomleft", legend = genera.phylo.full, col = col.phylo, pch = 16, pt.bg = col.unique.spp, cex = 0.75, pt.cex = 0.82, bty = "n", text.font = 3)
text(part.coords[1], part.coords[2], "B", cex = 1.5)
text(-0.017, part.coords[2] - 0.005, "shape residual dataset (genera)")
...
plot(x = res.PCA$pc.scores[, 1],  # no flip for consistency
                 ...
                 cex.axis = 1.1, 
                 cex.lab = 1.3)
legend("bottomleft", legend = c("Aquatic", "Arboreal", "Terrestrial", "Hopping", "", "Carnivore", "Frugivore", "Granivore", "Folivore", "Omnivore"), col = c(rep("black", 4), "white", col.diet.5), border = NULL, pch = c(21, 24, 22, 23, rep(16, 6)), cex = 0.84, bty = "n")
text(part.coords[1] - 0.005, part.coords[2], "C", cex = 1.5)
text(0, part.coords[2] - 0.005, "shape residual (locomotion and diet)")
...
text(-0.017, part.coords[2]- 0.005, expression(paste("shape residual without ", italic("Notomys"))))
