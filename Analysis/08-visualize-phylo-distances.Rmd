...
# Plot
plot(master.table$phylo.d, master.table$morph.d, col = col.spp2, bg = col.spp1, pch = 21, xlab = "Phylogenetic distance (~million years since common ancestor)", ylab = "Morphological distance")
```

## Repeat Phylo/Morph distance plot but using residuals
```{r}
...
# Plot
plot(master.table.r$phylo.d, master.table.r$morph.d.r, col = col.spp2, bg = col.spp1, pch = 21, xlab = "Phylogenetic distance (~million years since common ancestor)", ylab = "Morphological distance of residuals")
```
