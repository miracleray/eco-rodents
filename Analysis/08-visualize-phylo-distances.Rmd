...
for (i in 1:length(region.names)) {
        ...
        plot(same.region.pairs$phylo.d, 
             ...
             xlab = "Phylogenetic distance (~million years since common ancestor)",  ylab = "Morphological distance")
...
## Plot phylo/morph distance tables by species in biome paired with others in same biome
```{r}
### Set up graphical parameters for a multi-part figure (see script 04)

## For loop to cycle through each biome

# Prune spp1 column to only species in each biome

## For each species left in spp1, ID spp that never overlap and keep only those pairs

# Subset graphical parameters
