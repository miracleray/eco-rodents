...
legend("topleft", legend = "full shape", inset = c(0.005, 0.01), bty = "n")
...
legend("topleft", legend = "residual shape", inset = c(0.005, 0.01), bty = "n")
legend("bottomright", legend = genera.phylo, col = col.phylo, pch = 16, cex = 0.6, pt.cex = 0.7, ncol = 5, bty = "n", inset = c(0.12, 0))
