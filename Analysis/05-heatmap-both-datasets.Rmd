...
# Set up graphics for PC2 colors
#diff.min <- variation.range(res.mean, res.PC2.min.h)
```
...
# Lateral view of mean to smallest
open3d(windowRect = c(0, 0, 600, 600))
procrustes.var.plot(res.mean, res.PC2.min.h, col = heat.colors, col.val = list(diff.min, diff.min))
#procrustes.var.plot(res.mean, res.PC2.min.h, col = heat.colors, col.val = PC1.var.r2[, "radius"])
view3d(phi = 90)
rgl.snapshot("../Data/Processed/Heatmaps/RP2_mean-sm_lat_test.png")
...
system("mogrify ../Data/Processed/Heatmaps/*.png -trim ../Data/Processed/*.png")
```
