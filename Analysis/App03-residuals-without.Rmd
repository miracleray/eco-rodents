...
Produces multipanel Supplementary Figure TK.
...
view3d(phi = 90)
rgl.snapshot("../Data/Processed/heatmap_RES_sm-mean_lat_NO2.png")
...
view3d(phi = 90)
rgl.snapshot("../Data/Processed/heatmap_RES_mean-big_lat_NO2.png")

# Dorsal view of mean to smallest
open3d(windowRect = c(0, 0, 600, 600))
procrustes.var.plot(res.mean.no, res.PC1.min.h.n2, col = heat.colors, col.val = PC1.var.r.n2[, "radius"]) 
view3d(phi = 0)  # flip cranium
rgl.snapshot("../Data/Processed/heatmap_RES_sm-mean_dor_NO2.png")

# Dorsal view of mean to biggest
open3d(windowRect = c(0, 0, 600, 600))
procrustes.var.plot(res.mean.no, res.PC1.max.h.n2, col = heat.colors, col.val = PC1.var.r.n2[, "radius"])
view3d(phi = 0)  # flip cranium
rgl.snapshot("../Data/Processed/heatmap_RES_mean-big_dor_NO2.png")
```
...
view3d(phi = 90)
rgl.snapshot("../Data/Processed/heatmap_NC1_sm-mean_lat_NC1.png")

# Lateral view of mean to biggest
open3d(windowRect = c(0, 0, 600, 600))
procrustes.var.plot(res.mean.NC, res.PC1.max.NC, col = heat.colors, col.val = PC1.var.NC1[, "radius"])
view3d(phi = 90)
rgl.snapshot("../Data/Processed/heatmap_NC1_mean-big_lat_NC1.png")

# Dorsal view of mean to smallest
open3d(windowRect = c(0, 0, 600, 600))
procrustes.var.plot(res.mean.NC, res.PC1.min.NC, col = heat.colors, col.val = PC1.var.NC1[, "radius"]) 
view3d(phi = 0)  # flip cranium
rgl.snapshot("../Data/Processed/heatmap_NC1_sm-mean_dor_NC1.png")

# Dorsal view of mean to biggest
open3d(windowRect = c(0, 0, 600, 600))
procrustes.var.plot(res.mean.NC, res.PC1.max.NC, col = heat.colors, col.val = PC1.var.NC1[, "radius"])
view3d(phi = 0)  # flip cranium
rgl.snapshot("../Data/Processed/heatmap_NC1_mean-big_dor_NC1.png")
```
...
view3d(phi = 90)
rgl.snapshot("../Data/Processed/heatmap_NC2_sm-mean_lat_NC2.png")

# Lateral view of mean to biggest
open3d(windowRect = c(0, 0, 600, 600))
procrustes.var.plot(res.mean.NC, res.PC2.max.NC2, col = heat.colors, col.val = PC1.var.r.NC2[, "radius"])
view3d(phi = 90)
rgl.snapshot("../Data/Processed/heatmap_NC2_mean-big_lat_NC2.png")

# Dorsal view of mean to smallest
open3d(windowRect = c(0, 0, 600, 600))
procrustes.var.plot(res.mean.NC, res.PC2.min.NC2, col = heat.colors, col.val = PC1.var.r.NC2[, "radius"]) 
view3d(phi = 0)  # flip cranium
rgl.snapshot("../Data/Processed/heatmap_NC2_sm-mean_dor_NC2.png")

# Dorsal view of mean to biggest
open3d(windowRect = c(0, 0, 600, 600))
procrustes.var.plot(res.mean.NC, res.PC2.max.NC2, col = heat.colors, col.val = PC1.var.r.NC2[, "radius"])
view3d(phi = 0)  # flip cranium
rgl.snapshot("../Data/Processed/heatmap_NC2_mean-big_dor_NC2.png")
```
...
resid.sm.lat.n2 <- readPNG("../Data/Processed/heatmap_RES_sm-mean_lat_NO2.png")
resid.big.lat.n2 <- readPNG("../Data/Processed/heatmap_RES_mean-big_lat_NO2.png")
resid.sm.dor.n2 <- readPNG("../Data/Processed/heatmap_RES_sm-mean_dor_NO2.png")
resid.big.dor.n2 <- readPNG("../Data/Processed/heatmap_RES_mean-big_dor_NO2.png")

# Load in without notomys or carnivores residuals PC1
resNC1.sm.lat <- readPNG("../Data/Processed/heatmap_NC1_sm-mean_lat_NC1.png")
resNC1.big.lat <- readPNG("../Data/Processed/heatmap_NC1_mean-big_lat_NC1.png")
resNC1.sm.dor <- readPNG("../Data/Processed/heatmap_NC1_sm-mean_dor_NC1.png")
resNC1.big.dor <- readPNG("../Data/Processed/heatmap_NC1_mean-big_dor_NC1.png")

# Load in without notomys or carnivores residuals PC2
resNC2.sm.lat <- readPNG("../Data/Processed/heatmap_NC2_sm-mean_lat_NC2.png")
resNC2.big.lat <- readPNG("../Data/Processed/heatmap_NC2_mean-big_lat_NC2.png")
resNC2.sm.dor <- readPNG("../Data/Processed/heatmap_NC2_sm-mean_dor_NC2.png")
resNC2.big.dor <- readPNG("../Data/Processed/heatmap_NC2_mean-big_dor_NC2.png")
```

## 2) Make multi-panel Supplementary Figure TK: Heatmaps with Residuals
```{r}
# Set up muli-panel figure
pdf("../Data/Results/SFigureTK_Heatmap_Residuals_without.pdf")
...
legend("topright", inset = c(0.1, 0), legend = expression(paste("PC2 Residuals (no ", italic("Notomys"), ")")), bty = "n", cex = 1.2)
...
legend("topright", inset = c(0.1, 0), legend = expression(paste("PC1 Residuals (no ", italic("Notomys"), "or carnivores)")), bty = "n", cex = 1.1)
...
legend("topright", inset = c(0.17, 0), legend = expression(paste("PC2 Residuals (no ", italic("Notomys"), "or carnivores)")), bty = "n", cex = 1.1)
