...
par(mar = c(1, 4, 3, 1))
plot(master.table$phylo.d, master.table$morph.d, col = master.table$col.spp1, bg = master.table$col.spp2, pch = 21, xaxt = 'n', ann = FALSE, ylim = c(0.007, 0.205), ylab = "Morph. distance")
...
plot(master.table.r$phylo.d, master.table.r$morph.d.r, col = master.table$col.spp1, bg = master.table$col.spp2, pch = 21, ylim = c(0.01, 0.28), xlab = "Phylogenetic distance (~million years since common ancestor)", ylab = "Morph. distance")
text(0.25, 0.265, "B", cex = 1.5)
legend("topleft", legend = "shape residual", inset = c(0.001, 0.023), bty = "n")
legend(4.57, 0.051, legend = genera.phylo.full, text.font = 3, col = col.phylo, pch = 16, cex = 0.55, pt.cex = 0.7, ncol = 5, x.intersp = 0.8, text.width = 1.2, bty = "n", inset = c(0.12, 0))
