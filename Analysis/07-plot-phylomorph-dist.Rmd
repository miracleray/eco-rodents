...
pdf("../Data/Results/Figure5_PhyloMorph_Dist.pdf")
...
par(mar = c(1, 4, 3, 1))
plot(master.table$phylo.d, master.table$morph.d, col = master.table$col.spp1, bg = master.table$col.spp2, pch = 21, xaxt = 'n', ylim = c(0.007, 0.205), ylab = "Morph. distance")
axis(1, labels = FALSE)
...
plot(master.table.r$phylo.d, master.table.r$morph.d.r, col = master.table$col.spp1, bg = master.table$col.spp2, pch = 21, ylim = c(0.01, 0.28), xlab = "", ylab = "Morph. distance")
title(xlab = "Phylogenetic distance (~million years since common ancestor)", line = 2.3)
text(0.25, 0.265, "B", cex = 1.5)
legend("topleft", legend = "shape residual", inset = c(0.001, 0.024), bty = "n")
legend(4.5, 0.057, legend = genera.phylo.full, text.font = 3, col = col.phylo, pch = 16, cex = 0.65, pt.cex = 0.7, ncol = 5, x.intersp = 0.8, text.width = 1.2, bty = "n", inset = c(0.12, 0))
