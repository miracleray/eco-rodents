...
```{r}
test.data <- info[, c("Taxa", "Genus", "Species", "CatNum", "Order", "Csize", "Clade", "Feeding", "Guild")]  # relevant columns

# Subset out Hydromys and Xeromys
aquatic <- which(info$Guild == "Aquatic")  # specimens to remove
test.data <- test.data[-aquatic, ]  # metadata
test.shape <- shape[, , -aquatic]  # shape data
test.col.gen <- sp.col.gen[-aquatic]  # color information
test.pch.gen <- pch.spp[-aquatic]  # point shape information
