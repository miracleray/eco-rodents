...
## PCA with mean shape WITH ALLOMETRY for comparison
```{r}
...
### Then, plot residuals with consensus (WITHOUT allometry)
```{r}
...
### Alternately, as above but with only residuals no consensus added
```{r}
