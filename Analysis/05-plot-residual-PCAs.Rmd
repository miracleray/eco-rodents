...
col.omni <- sequential_hcl(5, "Grays")[3]  # gray for anything goes omnivore
...
pch.gld <- PlotByGroup(info.means, "Guild", pch.gld.4)
```
...
## 5) Export skreeplots for PC importance scores for 3 separate datasets
...
## 7) Compare the full shape and shape residual dataset PCAs
Mantel tests to compare full morphospace
```{r}
