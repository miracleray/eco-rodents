...
# Aquatic (circle), Arboreal (tri), Terrestrial (square), Hopping (diamond)
...
## Export skreeplots for PC importance scores for 3 separate datasets
```{r}
...
## Compare the full shape and shape residual dataset PCAs
