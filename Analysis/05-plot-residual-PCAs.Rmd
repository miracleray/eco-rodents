...
pch.gld.means <- PlotByGroup(info.means, "Guild", pch.gld.3)
...
PCA.plot <- plot(x = -res.PCA$pc.scores[, 1],  # Flip for consistency
                 ...
                 cex.axis = 1.3, 
                 cex.lab = 1.3)
legend("topright", legend = c("Carnivore ", "Frugivore ", "Granivore ", "Herbivore ", "Omnivore "), col = col.diet.5, border = NULL, pch = 15)
legend("bottomright", legend = c("Aquatic", "Arboreal", "Terrestrial"), col = "black", border = NULL, pch = c(21, 24, 22))
```
