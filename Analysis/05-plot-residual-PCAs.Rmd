...
# 1) 
barplot(full.PC.impt[, 2], main = "A) full shape dataset")
abline(h = 0.1, col = 'deeppink4')

# 2)
barplot(res.PC.impt[, 2], main = "B) residual shape dataset")
abline(h = 0.1, col = 'deeppink4')

# 3)
barplot(rnot.PC.impt[, 2], main = expression(paste("C) residual shape dataset without ", italic(Notomys))))
abline(h = 0.1, col = 'deeppink4')
