...
# 1) 
barplot(full.PC.impt[, 2], ylab = "% of variance", ylim = c(0, 0.5))
abline(h = 0.1, col = 'deeppink4')
legend("topleft", inset = c(0.07, -0.07), legend = "A) full shape dataset", bty = "n", cex = 1.2)

# 2)
barplot(res.PC.impt[, 2], ylab = "% of variance", ylim = c(0, 0.5))
abline(h = 0.1, col = 'deeppink4')
legend("topleft", inset = c(0.07, -0.07), legend = "B) shape residual dataset", bty = "n", cex = 1.2)

# 3)
barplot(rnot.PC.impt[, 2], xlab = "Principal component" , ylab = "% of variance", ylim = c(0, 0.5))
abline(h = 0.1, col = 'deeppink4')
