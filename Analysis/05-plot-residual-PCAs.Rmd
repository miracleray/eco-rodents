...
plot(x = -mean.PCA$pc.scores[, 1],  # Flip for consistency
                 ...
                 cex.axis = 1.1, 
                 cex.lab = 1.3)
text(-0.072, 0.075, "A", cex = 1.5)
text(0.0245, 0.075, "shape with allometry by genera")
...
plot(x = -res.PCA$pc.scores[, 1],  # Flip for consistency
                 ...
                 cex.axis = 1.1, 
                 cex.lab = 1.3)
legend("bottomright", legend = genera.phylo, col = col.phylo, pch = 16, pt.bg = col.unique.spp, cex = 0.85, bty = "n")
text(-0.117, 0.13, "B", cex = 1.5)
text(0.025, 0.13, "shape residuals by genera")
...
plot(x = wrap.PCA.r.n$pc.scores[, 1],  
                 ...
                 cex.axis = 1.1, 
                 cex.lab = 1.3)
text(-0.083, 0.16, "C", cex = 1.5)
text(0.036, 0.16, "residuals without Notomys")
...
plot(x = -res.PCA$pc.scores[, 1],  # Flip for consistency
                 ...
                 cex.axis = 1.1, 
                 cex.lab = 1.3)
legend("bottomright", legend = c("Aquatic", "Arboreal", "Terrestrial", "Hopping", "", "Carnivore", "Frugivore", "Granivore", "Herbivore", "Omnivore"), col = c(rep("black", 4), "white", col.diet.5), border = NULL, pch = c(21, 24, 22, 23, rep(15, 6)), cex = 0.9, bty = "n")
text(-0.11, 0.15, "D", cex = 1.5)
text(0.065, 0.15, "residuals by locomotion and diet")
