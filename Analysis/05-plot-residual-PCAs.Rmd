...
text(0.045, part.coords[2], "residual shape dataset (genera)")
...
text(0.06, part.coords[2], "residual shape (diet and locomotion)")
...
text(0.043, part.coords[2], expression(paste("residual shape without ", italic("Notomys"))))
