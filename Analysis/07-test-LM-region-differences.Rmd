...
legend("topleft", "module definitions", cex = 0.9, bty = "n", inset = c(0.03, 0.00))
legend("topleft", "(observed condition)", cex = 0.9, bty = "n", inset = c(0.03, 0.05))
...
text(12, 200, "Vault", cex = 0.9, bty = "n", col = darken(mod.colors[5], amount = 0.35))
