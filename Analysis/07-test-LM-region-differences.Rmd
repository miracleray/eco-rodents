...
legend("topleft", "module definitions (observed condition)", cex = 0.9, bty = "n", inset = c(0.05, 0.018))
text(60, -3, "Basicranium", cex = 0.9, bty = "n", col = darken(mod.colors[1]))
text(360, 20, "Molar", cex = 0.9, bty = "n", col = mod.colors[2])
text(330, 260, "Orbital", cex = 0.9, bty = "n", col = darken(mod.colors[3]))
text(585, 200, "Rostrum", cex = 0.9, bty = "n", col = darken(mod.colors[4], amount = 0.3))
text(10, 220, "Vault", cex = 0.9, bty = "n", col = darken(mod.colors[5], amount = 0.35))
...
text(mod.test.5.phy$CR - 0.055, 200, "observed CR", cex = 0.9, col = "darkred")
legend("topleft", "B", cex = 1.5, bty = "n", inset = -0.05)
legend("topleft", "full shape", cex = 0.9, bty = "n", inset = c(0.06, 0.02))
...
text(mod.test.5.res$CR - 0.03, 120, "observed CR", cex = 0.9, col = "darkred")
legend("topleft", "C", cex = 1.5, bty = "n", inset = -0.05)
legend("topleft", "shape residual", cex = 0.9, bty = "n", inset = c(0.06, 0.02))
