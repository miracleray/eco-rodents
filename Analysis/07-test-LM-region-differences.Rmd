...
legend("topleft", "module definitions (observed condition)", cex = 0.9, bty = "n", inset = c(0.05, 0))
text(60, -3, "Basicranium", cex = 0.9, bty = "n", col = darken(mod.colors[1]))
text(350, 20, "Molar", cex = 0.9, bty = "n", col = mod.colors[2])
text(320, 275, "Orbital", cex = 0.9, bty = "n", col = darken(mod.colors[3]))
text(550, 200, "Rostrum", cex = 0.9, bty = "n", col = darken(mod.colors[4], amount = 0.3))
...
legend("topleft", "full shape", cex = 0.9, bty = "n", inset = c(0.07, 0.02))
