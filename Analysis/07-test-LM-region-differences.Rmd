...
# Make high resolution file of lateral 3D plot of the module partitions
...
setEPS() 
postscript("../Data/Results/Figure4_Modularity.eps")
...
text(33, 195, "A", cex = 1.5)
text(143, 196, "module definitions (observed condition)", cex = 0.9)
text(70, -10, "Basicranium", cex = 0.9, bty = "n", col = mod.colors[1])
text(255, 15, "Molar", cex = 0.9, bty = "n", col = mod.colors[2])
text(275, 175, "Orbital", cex = 0.9, bty = "n", col = mod.colors[3])
text(415, 138, "Rostrum", cex = 0.9, bty = "n", col = mod.colors[4])
text(15, 160, "Vault", cex = 0.9, bty = "n", col = wes_palette("GrandBudapest2")[4])  # similar but darker color

# 2) Plot of CR ratios (with phylogenetic correction)
par(mar = c(3.5, 3.5, 1.5, 0.5))  # margins; need most space left & bottom for labels
...
title(ylab = "Frequency (out of 1000)", line = 2.45)
arrows(x0 = mod.test.5.phy$CR, y0 = 200, y1 = 8, length = 0.15, lwd = 1.5, col = "darkred")
text(mod.test.5.phy$CR - 0.003, 225, "observed CR", cex = 0.9, col = "darkred")
text(0.9, 395, "B", cex = 1.5)
text(0.936, 397, "resampled CR coefficients", cex = 0.9)
