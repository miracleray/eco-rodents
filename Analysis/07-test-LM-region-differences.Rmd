...
## Test modularity with 5 modules for shape residual dataset
...
text(mod.test.5$CR, 525, "observed CR", cex = 0.9, col = "darkred")
legend("topleft", "B", cex = 1.5, bty = "n", inset = -0.05)
legend("topleft", "resampled CR coefficients; full shape", cex = 0.9, bty = "n", inset = c(0.034, 0.02))

# 3) Plot of CR coefficients for shape residual dataset
par(mar = c(3.5, 3.5, 1.5, 0.5))
...
text(mod.test.res$CR + 0.02, 425, "observed CR", cex = 0.9, col = "darkred")
legend("topleft", "C", cex = 1.5, bty = "n", inset = -0.05)
legend("topleft", "resampled CR coefficients; shape residual", cex = 0.9, bty = "n", inset = c(0.035, 0.02))
...
legend("topleft", "as above, with phylogenetic correction", cex = 0.9, bty = "n", inset = c(0.033, 0.02))

# 5) Plot of CR coefficients (w/ phylo correction) for shape residual dataset
par(mar = c(3.5, 3.5, 1.5, 0.5))
