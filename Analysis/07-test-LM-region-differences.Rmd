...
arrows(x0 = mod.test.5$CR, y0 = 200, y1 = 8, length = 0.15, lwd = 1.5, col = "darkred")
text(mod.test.5$CR - 0.001, 230, "observed CR", cex = 0.9, col = "darkred")
text(0.65, 427, "B", cex = 1.5)
text(0.936, 431, "resampled CR coefficients; full shape dataset", cex = 0.9)
...
title(xlab = "Covariance ratio (CR) coefficient", line = 2.4)
title(ylab = "Frequency (out of 1000)", line = 2.35)
arrows(x0 = mod.test.res$CR, y0 = 200, y1 = 8, length = 0.15, lwd = 1.5, col = "darkred")
text(mod.test.res$CR - 0.001, 230, "observed CR", cex = 0.9, col = "darkred")
text(0.65, 427, "C", cex = 1.5)
text(0.936, 431, "resampled CR coefficients; residual shape", cex = 0.9)
...
text(0.65, 427, "D", cex = 1.5)
text(0.936, 431, "with phylogenetic correction", cex = 0.9)
...
title(xlab = "Covariance ratio (CR) coefficient", line = 2.4)
title(ylab = "Frequency (out of 1000)", line = 2.35)
arrows(x0 = mod.test.5.res$CR, y0 = 200, y1 = 8, length = 0.15, lwd = 1.5, col = "darkred")
text(mod.test.5.res$CR - 0.001, 230, "observed CR", cex = 0.9, col = "darkred")
text(0.65, 427, "E", cex = 1.5)
text(0.936, 431, "with phylogenetic correction", cex = 0.9)
...
# Export Table 1A and B
write.table(mantel.full, "../Data/Results/Table1A_MantelTest_Full.csv", sep = ",", col.names = NA)
write.table(mantel.res, "../Data/Results/Table1A_MantelTest_Res.csv", sep = ",", col.names = NA)
```
