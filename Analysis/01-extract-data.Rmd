...
#now run separate GPAs for each module
...
module_csizes <- list (basicran=NULL, molar=NULL, orbital=NULL, rostrum=NULL, vault=NULL)
...
#Get unique names for bilateral symmetry analyses

module_pairs <- list (basicran=NULL, molar=NULL, orbital=NULL, rostrum=NULL, vault=NULL)
...
#run bilateraly symmetry analyses of all modules with the module pairs:

module_bilat <- list (basicran=NULL, molar=NULL, orbital=NULL, rostrum=NULL, vault=NULL)

for (i in 1:length(module_gpas)){
  
module_bilat [[i]] <- bilat.symmetry(module_gpas$coords, ind = big.sp.info$All, object.sym = TRUE, replicate = NULL, side = NULL, land.pairs = big.land.pairs)
 
}


#Just checking how the "ind" vector works - it's the same as the dimnames.
