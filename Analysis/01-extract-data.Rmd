...
```{r}
save(big.bY.shape, big.sp.info, sm.bY.shape, sm.sp.info, rep.spec, big.pt.names, sm.pt.names, module_shape,module_list, file = "../Data/Processed/01-bilat-data-w-ERR.rda")
