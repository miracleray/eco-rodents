...
### Add centroid size to metadata & save Procrustes dist matrix from gpagen
...
```{r}
save(big.bY.shape, big.sp.info, sm.bY.shape, sm.sp.info, rep.spec, big.pt.names, sm.pt.names, shape.matrix, file = "../Data/Processed/01-bilat-data-w-ERR.rda")
