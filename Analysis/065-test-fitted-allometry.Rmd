...
3) Using the lengthy workaround suggested by the function's documentation.

Is relevant to Figure 2's second column, which is currently using #1
...
legend("topright", inset = c(0.22, 0), legend = "procD.lm $fitted", bty = "n", cex = 1.2)
...
text(0, dim(GMfit.sm.lat)[1]-10, "I", cex = 2)
...
text(0, dim(GMfit.big.lat)[1]-10, "J", cex = 2)
...
text(0, dim(GMfit.big.dor)[1]-10, "K", cex = 2)
...
text(0, dim(GMfit.big.dor)[1]-10, "L", cex = 2)
...
text(0, dim(regsc.sm.lat)[1]-10, "A", cex = 2)
legend("topright", inset = c(0.25, 0), legend = "Regression Workflow", bty = "n", cex = 1.2)
#legend("bottomleft", "Mean to hypothetical minimum", bty = "n", inset = c(0.1, 0.05))
...
text(0, dim(regsc.big.lat)[1]-10, "B", cex = 2)
#legend("bottomleft", "Mean to hypothetical maximum", bty = "n", inset = c(0.1, 0.12))
...
text(0, dim(regsc.big.dor)[1]-10, "C", cex = 2)
...
text(0, dim(regsc.big.dor)[1]-10, "D", cex = 2)
