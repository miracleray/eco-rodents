...
Integration_results <- cbind(R_pls_matrix, c(rep(NA,5)),R_pls_matrix_res)
...
#phylo.modularity provides a pairwise table. Here, upper is full data and lower is residuals
