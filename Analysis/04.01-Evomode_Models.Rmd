...
#just while building the code and I hope I won't for get to take this out- saving progress here.

```{r}

save.image(file="../Data/Processed/temp_evomode_allometry_workspace.rda")
...
load(file="../Data/Processed/temp_evomode_allometry_workspace.rda" )
