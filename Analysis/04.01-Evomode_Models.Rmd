...
allometry.all <- procD.pgls(coords ~ Csize, aus.tree, data = allom_GDF)
...
#After finding that the residuals of the OU and the residuals of the conventional pgls model are nearly identical (same with just the residuals of just modelling shape evolution under BM/OU), deciding to continue with just pgls-based analyses. It's unlikely that we will get substantial differences. 
