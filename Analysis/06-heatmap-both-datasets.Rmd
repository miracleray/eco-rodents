...
Tree, mean shape, and metadata for phylogenetic analyses come from the allometry rodents script 03. Residual data for Fig. 3 comes from script 05.
```{r message = FALSE}
library(geomorph)
...
legend("topleft", inset = c(.015, 0), legend = "Smallest/Largest Individuals", bty = "n", cex = 1.2)
...
legend("topright", inset = c(0.5, 0), legend = "PC1 residual shape", bty = "n", cex = 1.2)
legend("bottomleft", "Mean to hypothetical minimum", bty = "n", inset = c(0.1, 0.07))
...
legend("topright", inset = c(0.1, 0), legend = expression(paste("PC1 residual shape (no ", italic("Notomys"), ")")), bty = "n", cex = 1.2)
...
legend("topright", inset = c(0.3, 0), legend = "PC2 shape residual data (all spp.)", bty = "n", cex = 1.2)
