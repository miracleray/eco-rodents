...
layout(mat, widths = c(1, 1, 1), heights = c(rep(0.5, 4)))
...
legend("bottomleft", "Mean to P. delicatulus", bty = "n", inset = c(0.1, 0.07))
...
legend("bottomleft", "Mean to U. caudimaculatus", bty = "n", inset = c(0.1, 0.07))
...
legend("bottomleft", "Mean to P. delicatulus, fitted shape", bty = "n", inset = c(0.03, 0.07))
...
legend("bottomleft", "Mean to U. caudimaculatus, fitted shape", bty = "n", inset = c(0.03, 0.07))
...
legend("bottomleft", "Mean to new hypothetical minimum", bty = "n", inset = c(0.1, 0.05))
...
legend("bottomleft", "Mean to new hypothetical maximum", bty = "n", inset = c(0.1, 0.12))
...
legend("bottomleft", "Mean to PC2 hypothetical minimum", bty = "n", inset = c(0.1, 0.05))
...
legend("bottomleft", "Mean to PC2 hypothetical maximum", bty = "n", inset = c(0.1, 0.12))
