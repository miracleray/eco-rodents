...
## Make multi-panel Figure 2, heatmaps with allometry
```{r}
...
text(0, dim(allPC.sm.lat)[1]-10, "E", cex = 2)
...
text(0, dim(allPC.big.lat)[1]-10, "F", cex = 2)
...
text(0, dim(allPC.big.dor)[1]-10, "G", cex = 2)
...
## Make multi-panel Figure 3: Heatmaps with Residuals
```{r}
# Set up muli-panel figure; lateral 
