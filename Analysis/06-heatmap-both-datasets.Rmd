...
# Find min and max shapes    
r.min.name <- names(which(res.PCA$pc.scores[, 1] == min(res.PCA$pc.scores[, 1])))
r.max.name <- names(which(res.PCA$pc.scores[, 1] == max(res.PCA$pc.scores[, 1])))
...
r2.min.name <- names(which(res.PCA$pc.scores[, 2] == min(res.PCA$pc.scores[, 2])))
r2.max.name <- names(which(res.PCA$pc.scores[, 2] == max(res.PCA$pc.scores[, 2])))
