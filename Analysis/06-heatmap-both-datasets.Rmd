...
par(mar = c(0, 0, 1, 0))  # sets the margins
plot(c(0, dim(allom.sm.dor)[2]), c(0, dim(allom.sm.dor)[1]), type = "n", axes = F, xlab = "", ylab = "", asp = T) 
rasterImage(allom.sm.dor, 0, 0, dim(allom.sm.dor)[2], dim(allom.sm.dor)[1])
text(0, dim(allom.sm.dor)[1]-10, "E", cex = 2)

# 6) Small to Mean, without Allometry, dorsal view
par(mar = c(0, 0, 1, 0))
plot(c(0, dim(resid.sm.dor)[2]), c(0, dim(resid.sm.dor)[1]), type = "n", axes = F, xlab = "", ylab = "", asp = T) 
rasterImage(resid.sm.dor, 0, 0, dim(resid.sm.dor)[2], dim(resid.sm.dor)[1])
text(0, dim(resid.sm.dor)[1]-10, "F", cex = 2)
