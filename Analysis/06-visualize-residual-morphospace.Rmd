...
#text(nc.res.PCA$pc.scores[, 1], nc.res.PCA$pc.scores[, 2], labels = nc.info.means.tree$Taxa)
```
...
PCA.plot <- plot(x = not.res.PCA$pc.scores[, 1],
                 ...
                 cex.axis = 1.3, 
                 cex.lab = 1.3)
legend("bottomright", not.phylo.names, col = not.phylo.cols, pch = not.phylo.pch, pt.bg = not.phylo.cols, cex = .57, pt.cex = 1.5, ncol = 2)
```
