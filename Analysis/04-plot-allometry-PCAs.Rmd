...
## PCA plot by diet and guild - IMPT FIGURE
...
## Check for disparity differences
...
# This identifies the centroid of the old endemic species to then test the multidimensional position of the new endemic species against
old.centroid <- apply(traitspace[, gpagen.shape$endemic == "Old"], 2, mean)

# This computes the distance of both groups from the old endemics' center; summary gives the stats, plot gives the boxplot
dist.from.old <- dispRity(traitspace, metric = centroids, centroid = old.centroid)
