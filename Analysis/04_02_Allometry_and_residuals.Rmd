...
rownames(physig_table_modules)<- names(mean_modules)
colnames(physig_table_modules) <- c("K", "p")
...
for (i in (1: length(mean_modules))){
  ...
  physig_table_modules[i,1] <- temp$phy.signal
   physig_table_modules[i,2] <- temp$pvalue
